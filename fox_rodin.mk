...
# Settings persistence: load settings early and store in a deterministic
# path that does not depend on the user-visible sdcard mount.
FOX_ALLOW_EARLY_SETTINGS_LOAD := 1
FOX_SETTINGS_ROOT_DIRECTORY := /cache/recovery
FOX_MISCELLANEOUS_ROOT_DIRECTORY := /cache/recovery
